...
public class KeyBindings {
    ...
    public static boolean isActiveIgnoreContext(KeyBinding keyBinding) {
        return keyBinding.getKey().getType() == InputMappings.Type.KEYSYM && InputMappings.isKeyDown(Minecraft.getInstance().mainWindow.getHandle(), keyBinding.getKey().getKeyCode());
    }
