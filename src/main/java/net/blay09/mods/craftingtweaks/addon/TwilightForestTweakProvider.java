...
public class TwilightForestTweakProvider implements TweakProvider {

    private final DefaultProvider defaultProvider = CraftingTweaksAPI.createDefaultProvider();
    private boolean isLoaded;
    private Field craftMatrixField;

    public TwilightForestTweakProvider() {
        try {
            Class clazz = Class.forName("twilightforest.uncrafting.ContainerTFUncrafting");
            craftMatrixField = clazz.getField("assemblyMatrix");
            isLoaded = true;
