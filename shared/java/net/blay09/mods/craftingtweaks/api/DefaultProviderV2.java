...
public interface DefaultProviderV2 {
     ...
     */
    <T extends AbstractContainerMenu> void rotateGrid(TweakProvider<T> provider, int id, Player entityPlayer, T container, boolean counterClockwise);
     ...
     * @param counterClockwise true if the rotation should happen counter clockwise
     */
    <T extends AbstractContainerMenu> void rotateGrid(TweakProvider<T> provider, int id, Player entityPlayer, T container, RotationHandler rotationHandler, boolean counterClockwise);
     ...
     */
    <T extends AbstractContainerMenu> void clearGrid(TweakProvider<T> provider, int id, Player entityPlayer, T container, boolean phantomItems, boolean forced);
     ...
     * @param container the container the grid is part of
     */
    <T extends AbstractContainerMenu> void balanceGrid(TweakProvider<T> provider, int id, Player entityPlayer, T container);
     ...
     * @param container the container the grid is part of
     */
    <T extends AbstractContainerMenu> void spreadGrid(TweakProvider<T> provider, int id, Player entityPlayer, T container);
     ...
     */
    <T extends AbstractContainerMenu> ItemStack putIntoGrid(TweakProvider<T> provider, int id, Player entityPlayer, T container, ItemStack itemStack, int index);
     ...
     */
    <T extends AbstractContainerMenu> boolean transferIntoGrid(TweakProvider<T> provider, int id, Player entityPlayer, T container, Slot sourceSlot);
     ...
     */
    <T extends AbstractContainerMenu> boolean canTransferFrom(Player entityPlayer, T container, Slot sourceSlot);
}
