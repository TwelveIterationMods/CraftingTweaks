...
public class CraftingTweaks {
    ...
    public CraftingTweaks() {
        ...
        ModLoadingContext.get().registerConfig(ModConfig.Type.COMMON, CraftingTweaksConfigData.commonSpec);
        ModLoadingContext.get().registerConfig(ModConfig.Type.CLIENT, CraftingTweaksConfigData.clientSpec);
    ...
    private void setup(FMLCommonSetupEvent event) {
        DeferredWorkQueue.runLater(ModNetworking::init);
