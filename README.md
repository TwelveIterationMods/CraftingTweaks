...
out [issues labelled as "help wanted"](https://github.com/TwelveIterations/CraftingTweaks/issues?q=is%3Aopen+is%3Aissue+label%3A%22help+wanted%22).
...
dependencies {
    ...
    // Forge: implementation "curse.maven:crafting-tweaks-233071:${craftingtweaks_file_id}"
...
dependencies {
    ...
    // Forge: implementation "net.blay09.mods:craftingtweaks-forge:${craftingtweaks_version}"
